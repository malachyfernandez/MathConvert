...
- visiting `https://paper.malachyf.com` on iPhone Safari = **web behavior**

If the user is on `paper.malachyf.com` in Safari, the upload flow must be treated as **mobile web**.
